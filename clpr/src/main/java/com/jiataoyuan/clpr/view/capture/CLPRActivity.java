package com.jiataoyuan.clpr.view.capture;
...
import com.jiataoyuan.clpr.IDef;
import com.jiataoyuan.clpr.R;
import com.jiataoyuan.clpr.RecognizeThread;
import com.jiataoyuan.clpr.util.FooSysUtil;
import com.jiataoyuan.clpr.util.PermissionUtils;
...
public class CLPRActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PermissionUtils.CODE_REQUEST_PERMISSION) {
            if (PermissionUtils.HavecheckPermission(CLPRActivity.this)) {
                //初始化照相机
                openCamera();
                startPreview();
            }
