package com.jiataoyuan.clpr.view.video;
...
public class VLPRActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PermissionUtils.CODE_REQUEST_PERMISSION) {
            if (PermissionUtils.HavecheckPermission(VLPRActivity.this)) {
                //初始化照相机
                openCamera();
                startPreview();
            }
